...
`@SinceMirai("0.34.0") interface ConstrainSingle<out M : `[`Message`](../-message/index.md)`> : `[`MessageMetadata`](../-message-metadata.md)
...
| [key](key.md) | `abstract val key: Key<M>` |
...
| [MessageSource](../-message-source/index.md) | 消息源, 它存在于 [MessageChain](../-message-chain/index.md) 中, 用于表示这个消息的来源.`sealed class MessageSource : `[`Message`](../-message/index.md)`, `[`MessageMetadata`](../-message-metadata.md)`, `[`ConstrainSingle`](./index.md)`<`[`MessageSource`](../-message-source/index.md)`>` |
| [QuoteReply](../-quote-reply/index.md) | 引用回复.`class QuoteReply : `[`Message`](../-message/index.md)`, `[`MessageMetadata`](../-message-metadata.md)`, `[`ConstrainSingle`](./index.md)`<`[`QuoteReply`](../-quote-reply/index.md)`>` |
