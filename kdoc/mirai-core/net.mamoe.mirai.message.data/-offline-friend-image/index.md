[mirai-core](../../index.md) / [net.mamoe.mirai.message.data](../index.md) / [OfflineFriendImage](./index.md)

# OfflineFriendImage

`data class OfflineFriendImage : `[`FriendImage`](../-friend-image/index.md)`, `[`OfflineImage`](../-offline-image/index.md)
...
| [&lt;init&gt;](-init-.md) | 通过 [Group.uploadImage](../../net.mamoe.mirai.contact/-group/upload-image.md) 上传得到的 [GroupImage](../-group-image/index.md). 它的链接需要查询 [Bot.queryImageUrl](../../net.mamoe.mirai/-bot/query-image-url.md)`OfflineFriendImage(imageId: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`)` |
