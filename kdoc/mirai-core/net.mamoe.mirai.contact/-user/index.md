...
| [uploadImage](upload-image.md) | 上传一个图片以备发送.`abstract suspend fun uploadImage(image: `[`ExternalImage`](../../net.mamoe.mirai.utils/-external-image/index.md)`): `[`OfflineFriendImage`](../../net.mamoe.mirai.message.data/-offline-friend-image/index.md) |
...
| [QQ](../-q-q/index.md) | QQ 对象.`abstract class ~~QQ~~ : `[`User`](./index.md)`, CoroutineScope` |
